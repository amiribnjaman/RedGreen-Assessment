    ...
    return (
        <div className='mt-3 flex justify-between mb-1'>
            <div className='flex items-center'>
                ...
                <div>
                    <h5 className='m-0 font-semibold dark:text-white'>{productName}</h5>
                    <h6 className='m-0 text-[11px] font-normal dark:text-white'>{productDate} <span> - {productAuthor}</span></h6>
                </div>
            </div>
